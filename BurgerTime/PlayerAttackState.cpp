...
void PlayerAttackState::InitAnimations()
{
	...
	const SDL_Rect up1Rect{ 2 * tileSize, 3 * tileSize, tileSize, tileSize };
	...
	const SDL_Rect down1Rect{ 0 * tileSize, 3 * tileSize, tileSize, tileSize };
	...
	const SDL_Rect side1Rect{ 1 * tileSize, 3 * tileSize, tileSize, tileSize };
