...
void PlayerDieState::InitAnimations(MoE::TextureRenderer* renderComp)
{
	...
	const SDL_Rect caught1Rect{ 0 * tileSize, 4 * tileSize, tileSize, tileSize };
	const SDL_Rect caught2Rect{ 1 * tileSize, 4 * tileSize, tileSize, tileSize };
	...
	const SDL_Rect fall1Rect{ 2 * tileSize, 4 * tileSize, tileSize, tileSize };
	const SDL_Rect fall2Rect{ 0 * tileSize, 5 * tileSize, tileSize, tileSize };
	...
	const SDL_Rect down1Rect{ 1 * tileSize, 5 * tileSize, tileSize, tileSize };
	const SDL_Rect down2Rect{ 2 * tileSize, 5 * tileSize, tileSize, tileSize };
